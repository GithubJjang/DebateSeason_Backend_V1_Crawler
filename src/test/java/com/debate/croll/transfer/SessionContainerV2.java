...
public class SessionContainerV2 {
	...
	private final HeartBeatManagerV2 heartBeatManagerV2;

	public SessionContainerV2(){
		heartBeatManagerV2 = new HeartBeatManagerV2();
	}
	...
	public HeartBeatManagerV2 getHeartBeartManagerV2(){
		return heartBeatManagerV2;
	}
	...
	public int getUserCount(){
		return heartBeatManagerV2.getUserCount();
	}

	public int getOperationTime(){
		return heartBeatManagerV2.getOperationTime();
	}

	public void shutdownScheduler(){
		heartBeatManagerV2.shutdownScheduler();
	}
